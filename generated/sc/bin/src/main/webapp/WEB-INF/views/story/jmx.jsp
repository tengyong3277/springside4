...
<body>
	...
	<ul>
		...
		<li>Application Statistics Mbean, 当用户在综合演示里查看/更新用户时，计数器将会递增, name为sc:name=ApplicationStatistics</li>
	</ul>
	...
	查询：
	<ul>
		<li>列出sc域下的所有MBean及其描述: <br/><a href="${baseUrl}/jolokia/list/sc">${baseUrl}/jolokia/list/sc</a></li>
		<li>获取sc域下的所有MBean的属性: <br/><a href="${baseUrl}/jolokia/read/sc:name=*">${baseUrl}/jolokia/read/sc:name=*</a></li>
		<li>获取应用统计MBean的所有属性: <br/><a href="${baseUrl}/jolokia/read/sc:name=ApplicationStatistics">${baseUrl}/jolokia/read/sc:name=ApplicationStatistics</a></li>
		<li>只获取应用统计MBean的展示用户列表次数属性: <br/><a href="${baseUrl}/jolokia/read/sc:name=ApplicationStatistics/ListUserTimes">${baseUrl}/jolokia/read/sc:name=ApplicationStatistics/ListUserTimes</a></li>
	</ul>
	设置：
	<ul>
	...
	执行：
	<ul>
		<li>执行重置清零统计信息的命令: <br/><a href="${baseUrl}/jolokia/exec/sc:name=ApplicationStatistics/resetStatistics">${baseUrl}/jolokia/exec/sc:name=ApplicationStatistics/resetStatistics</a></li>
